...
#-------------------------------------------------------------------------------------
#CREACION DE BOTONES
l1=Button(vent,text='LED ON',command=button1,cursor='arrow')
l2=Button(vent,text='LED OFF',command=button2,cursor='arrow')
l3=Button(vent,text='CONTADOR',command=button3,cursor='arrow') 
